...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ss.source_files = "ios/Core/*.{h,m,mm,swift}"
  end

  # File
  s.subspec "File" do |ss|
    ss.source_files = "ios/File/*.{h,m,mm,swift}"
  end

  # PhotoBrowser
  s.subspec "PhotoBrowser" do |ss|
    ss.source_files = "ios/PhotoBrowser/*.{h,m,mm,swift}"
  ...
  s.subspec "Toast" do |ss|
    ss.source_files = "ios/Toast/*.{h,m,mm,swift}"
